  ...
  return (
    <div className="flex items-center gap-3 select-none">
      ...
      >
        ...
        {/* Clean Logo Image with Invert & Screen Blend for Pure Transparent Crisp Dark Rendering */}
        <img
          src="/asteya-logo.png"
          alt="ASTEYA Logo"
          className="relative z-10 w-full h-full object-contain filter invert mix-blend-screen drop-shadow-[0_0_12px_rgba(168,85,247,0.85)]"
        />
      </motion.div>
